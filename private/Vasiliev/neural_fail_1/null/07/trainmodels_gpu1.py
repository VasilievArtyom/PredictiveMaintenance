...
sequence_length_in = predictSteps * 5
...
# ###################### Main #########################################
for outputBlockId in range(5, 10):
    ...
    model = Sequential()
    model.add(LSTM(256, return_sequences=True, input_shape=(None, num_inData_signals,)))
    ...
    model.fit_generator(generator=generator_traindata, epochs=1000000, steps_per_epoch=733, validation_steps=142,
